...
Question encoding starts with normalization into the event stream and structural marking of interrogative intent. Retrieval then uses VSA to find top schemas and macro programs similar to the question hypervector.
